...
(1, '西湖龙井（明前）', 268.00, 'tea', '清香鲜爽，核心产区。', '/images/001.png', '杭州西湖', 'TRACE-LJ-001'),
(2, '武夷大红袍', 198.00, 'tea', '岩韵明显，回甘悠长。', '/images/002.png', '福建武夷山', 'TRACE-WY-002'),
(3, '安溪铁观音', 158.00, 'tea', '兰花香高扬。', '/images/003.png', '福建安溪', 'TRACE-AX-003'),
(4, '碧螺春（特级）', 288.00, 'tea', '卷曲如螺，白毫显露，清香幽雅。', '/images/004.png', '江苏苏州', 'TRACE-BLC-004'),
(5, '信阳毛尖', 178.00, 'tea', '细圆紧直，汤色嫩绿，滋味鲜爽。', '/images/005.png', '河南信阳', 'TRACE-XY-005'),
(6, '祁门红茶', 238.00, 'tea', '世界三大高香红茶，祁门香浓郁。', '/images/006.png', '安徽祁门', 'TRACE-QM-006'),
(7, '福鼎白茶', 328.00, 'tea', '自然萎凋，清甜回甘，存放越久越好。', '/images/007.png', '福建福鼎', 'TRACE-FD-007'),
(8, '凤凰单丛', 298.00, 'tea', '香型丰富，蜜兰香清雅高扬。', '/images/008.png', '广东潮州', 'TRACE-FH-008'),
(9, '六堡茶', 188.00, 'tea', '陈香显著，越陈越香，适合收藏。', '/images/009.png', '广西梧州', 'TRACE-LB-009'),
(10, '景德镇青花盖碗', 128.00, 'tool', '青花瓷盖碗，古典雅致，易清洗。', '/images/010.png', NULL, NULL),
(11, '宜兴紫砂壶 西施壶', 580.00, 'tool', '经典器型，全手工制作，透气性佳。', '/images/011.png', NULL, NULL),
(12, '紫砂壶 石瓢', 680.00, 'tool', '文人壶经典款，实用性强。', '/images/012.png', NULL, NULL),
(13, '紫砂壶（入门款）', 299.00, 'tool', '紫砂泥，透气性好。', '/images/013.png', NULL, NULL),
(14, '宜兴紫砂壶 潜孔壶', 580.00, 'tool', '文人壶经典款，古朴优雅。', '/images/014.png', NULL, NULL),
(15, '景德镇盖碗', 88.00, 'tool', '白瓷盖碗，易清洗。', '/images/015.png', NULL, NULL),
(16, '汝窑盖碗', 168.00, 'tool', '天青色釉面，温润如玉。', '/images/016.png', NULL, NULL),
(17, '玻璃公道杯', 58.00, 'tool', '耐热玻璃，观察茶汤更直观。', '/images/017.png', NULL, NULL),
(18, '陶瓷公道杯 茶海', 98.00, 'tool', '手绘青花，容量适中。', '/images/018.png', NULL, NULL),
(19, '羊脂玉品茗杯 套装', 188.00, 'tool', '一套4只，温润细腻，不烫手。', '/images/019.png', NULL, NULL),
(20, '建盏品茗杯', 228.00, 'tool', '天目釉，七彩光晕，养盏佳品。', '/images/001.png', NULL, NULL),
(21, '竹制茶盘', 158.00, 'tool', '天然竹材，排水设计，易清洁。', '/images/002.png', NULL, NULL),
(22, '实木茶盘 乌金石', 398.00, 'tool', '高档乌金石茶盘，大容量储水。', '/images/003.png', NULL, NULL),
(23, '茶叶罐 陶瓷密封', 78.00, 'tool', '双层密封，防潮防异味。', '/images/004.png', NULL, NULL),
(24, '茶漏 不锈钢', 28.00, 'tool', '精细过滤，防止茶叶进入茶杯。', '/images/005.png', NULL, NULL),
(25, '茶夹 茶针套装', 48.00, 'tool', '竹制六君子，实用美观。', '/images/006.png', NULL, NULL);
